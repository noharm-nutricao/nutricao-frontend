...
export default function PrioritizationCard({
  ...
  // Teste manual no PrioritizationCard.js
  /*const campo1 = prescription?.campo1 || {
    protocolo: "NRS2002",
    nrs_total: 5,
    classificacao: "cr",
    nrs_completo: false
  ...
  /*const campo1 = {
    protocolo: 'MNUTRIC',
    mnutric_total: 4,
    classificacao: 'md', // Deve ficar Amarelo (#eab308)
    dados_incompletos: true, // Deve exibir badge "APACHE/SOFA necessarios"
    mn_dims: { idade: 1, apache: 0, sofa: 0, comor: 2, dias: 1 },
    calculado_at: '2026-04-15T10:00:00Z'
  }*/

  const campo1 = {
    protocolo: 'NRS2002',
    nrs_total: 2,
    classificacao: 'bx', // Deve ficar Verde (#22c55e)
    nrs_completo: true, // Badge "Incompleto" NÃO deve aparecer
  ...
  /*const campo1 = {
    protocolo: 'NRS2002',
    nrs_total: 0,
    classificacao: null, // Card deve ficar Cinza (#959595) e sem borda colorida
    nrs_completo: false, // Badge "Incompleto" aparece
    nrs_dims: { nut: null, doenca: 0, idade: 0 },
    calculado_at: '2026-04-15T09:00:00Z'
  }*/

  /*const campo1 = {
    protocolo: 'NRS2002',
    nrs_total: 4,
    classificacao: 'al', // Deve ficar Laranja
    nrs_completo: true,
    nrs_dims: { nut: 2, doenca: 1, idade: 1 },
    calculado_at: '2026-04-15T12:00:00Z'
  }*/

  console.log('Prescription:',prescription);
  console.log("CONTEÚDO DO CAMPO 1:", prescription?.campo1);
  ...
  return (
    <Card
      $alert={
        campo1 ? campo1.classificacao : (prescription.dischargeReason ? "" : prescription.class)
      }
      href={href}
      target="_blank"
    >
      <div className="card-header">
        ...
        <div className={`stamp ${highlight ? "highlight" : ""}`}>
          ...
          {/* MODIFICAÇÃO: Envolvendo o valor do score em um Tooltip com o Breakdown (Critério de Aceite) */}
          <Tooltip title={breakdownText || "Escore Global"}>
            <div className="stamp-value">
              ...
              {/* Badge: Score Incompleto (Regra: nrs_completo = false) */}
              ...
              {/* Badge: APACHE/SOFA Necessários (Regra: dados_incompletos = true) */}
